...
public struct LoginRoot {
    public static let `default` = LoginRoot()
...
final public class SiginRes : GeneratedMessage {
    ...
    override public func writeTo(codedOutputStream: CodedOutputStream) throws {
        if hasUid {
            try codedOutputStream.writeString(fieldNumber: 1, value:uid)
        }
        if hasToken {
    ...
    override public func serializedSize() -> Int32 {
        ...
        serialize_size = 0
        if hasUid {
            serialize_size += uid.computeStringSize(fieldNumber: 1)
        }
        if hasToken {
    ...
    final public class Builder : GeneratedMessageBuilder {
        ...
        @discardableResult
        public func setUid(_ value:String) -> SiginRes.Builder {
            self.uid = value
            return self
        }
        @discardableResult
...
final public class LoginRes : GeneratedMessage {
    ...
    final public class Builder : GeneratedMessageBuilder {
        ...
        @discardableResult
        public func setUid(_ value:String) -> LoginRes.Builder {
            self.uid = value
            return self
        }
        @discardableResult
...
extension SigninReq: GeneratedMessageProtocol {
    ...
    public class func parseFrom(data: Data) throws -> SigninReq {
        return try SigninReq.Builder().mergeFrom(data: data, extensionRegistry:LoginRoot.default.extensionRegistry).build()
    }
...
extension LoginReq: GeneratedMessageProtocol {
    ...
    public class func parseFrom(data: Data) throws -> LoginReq {
        return try LoginReq.Builder().mergeFrom(data: data, extensionRegistry:LoginRoot.default.extensionRegistry).build()
    }
...
extension SiginRes: GeneratedMessageProtocol {
    ...
    public class func parseFrom(data: Data) throws -> SiginRes {
        return try SiginRes.Builder().mergeFrom(data: data, extensionRegistry:LoginRoot.default.extensionRegistry).build()
    }
...
extension LoginRes: GeneratedMessageProtocol {
    ...
    public class func parseFrom(data: Data) throws -> LoginRes {
        return try LoginRes.Builder().mergeFrom(data: data, extensionRegistry:LoginRoot.default.extensionRegistry).build()
    }
...
extension LogoutReq: GeneratedMessageProtocol {
    ...
    public class func parseFrom(data: Data) throws -> LogoutReq {
        return try LogoutReq.Builder().mergeFrom(data: data, extensionRegistry:LoginRoot.default.extensionRegistry).build()
    }
...
extension CommonRes: GeneratedMessageProtocol {
    ...
    public class func parseFrom(data: Data) throws -> CommonRes {
        return try CommonRes.Builder().mergeFrom(data: data, extensionRegistry:LoginRoot.default.extensionRegistry).build()
    }
