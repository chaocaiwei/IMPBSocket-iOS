...
final public class AddFriendReq : GeneratedMessage {
    ...
    override public func isInitialized() throws {
        if !hasTargetId {
            throw ProtocolBuffersError.invalidProtocolBuffer("Uninitialized Message \(AddFriendReq.self): field \"targetId\" mark required")
        }
    }
...
final public class ReceiveFriendReq : GeneratedMessage {
    ...
    override public func isInitialized() throws {
        if !hasIsReceive {
            throw ProtocolBuffersError.invalidProtocolBuffer("Uninitialized Message \(ReceiveFriendReq.self): field \"isReceive\" mark required")
        }
        if !hasTargetUid {
            throw ProtocolBuffersError.invalidProtocolBuffer("Uninitialized Message \(ReceiveFriendReq.self): field \"targetUid\" mark required")
        }
    }
    override public func writeTo(codedOutputStream: CodedOutputStream) throws {
        if hasIsReceive {
...
final public class AddFriendNoti : GeneratedMessage {
    ...
    override public func isInitialized() throws {
        if !hasOpId {
            throw ProtocolBuffersError.invalidProtocolBuffer("Uninitialized Message \(AddFriendNoti.self): field \"opId\" mark required")
        }
    }
    override public func writeTo(codedOutputStream: CodedOutputStream) throws {
        if hasOpId {
...
final public class ReceiveFriendNoti : GeneratedMessage {
    ...
    override public func isInitialized() throws {
        if !hasIsReceive {
            throw ProtocolBuffersError.invalidProtocolBuffer("Uninitialized Message \(ReceiveFriendNoti.self): field \"isReceive\" mark required")
        }
        if !hasOpUid {
            throw ProtocolBuffersError.invalidProtocolBuffer("Uninitialized Message \(ReceiveFriendNoti.self): field \"opUid\" mark required")
        }
    }
    override public func writeTo(codedOutputStream: CodedOutputStream) throws {
        if hasIsReceive {
...
final public class GetUserInfoById : GeneratedMessage {
    ...
    override public func isInitialized() throws {
        if !hasTargetId {
            throw ProtocolBuffersError.invalidProtocolBuffer("Uninitialized Message \(GetUserInfoById.self): field \"targetId\" mark required")
        }
    }
    override public func writeTo(codedOutputStream: CodedOutputStream) throws {
        if hasTargetId {
...
final public class UserInfoRes : GeneratedMessage {
    ...
    override public func isInitialized() throws {
        if !hasUserInfo {
            throw ProtocolBuffersError.invalidProtocolBuffer("Uninitialized Message \(UserInfoRes.self): field \"userInfo\" mark required")
        }
...
final public class UserInfoListRes : GeneratedMessage {
    ...
    public fileprivate(set) var userList:Array<UserInfo>  = Array<UserInfo>()
    required public init() {
        super.init()
    }
    override public func isInitialized() throws {
        for oneElementUserList in userList {
            try oneElementUserList.isInitialized()
        }
    }
    override public func writeTo(codedOutputStream: CodedOutputStream) throws {
        for oneElementUserList in userList {
    ...
    final public class Builder : GeneratedMessageBuilder {
        ...
        @discardableResult
        public func setUserList(_ value:Array<UserInfo>) -> UserInfoListRes.Builder {
            self.userList = value
            return self
        }
        @discardableResult
        ...
        override public func mergeFrom(codedInputStream: CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> UserInfoListRes.Builder {
            ...
            while (true) {
                ...
                case 10:
                    let subBuilder = UserInfo.Builder()
                    try codedInputStream.readMessage(builder: subBuilder,extensionRegistry:extensionRegistry)
        ...
        class override public func decodeToBuilder(jsonMap:Dictionary<String,Any>) throws -> UserInfoListRes.Builder {
            ...
            if let jsonValueUserList = jsonMap["userList"] as? Array<Dictionary<String,Any>> {
                var jsonArrayUserList:Array<UserInfo> = []
                for oneValueUserList in jsonValueUserList {
                    let messageFromStringUserList = try UserInfo.Builder.decodeToBuilder(jsonMap:oneValueUserList).build()
...
extension UserInfoListRes.Builder: GeneratedMessageBuilderProtocol {
    ...
    public subscript(key: String) -> Any? {
        ...
        set (newSubscriptValue) { 
            switch key {
            case "userList":
                guard let newSubscriptValue = newSubscriptValue as? Array<UserInfo> else {
                    return
                }
