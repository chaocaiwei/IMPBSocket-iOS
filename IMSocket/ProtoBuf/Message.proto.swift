...
public enum EnumMsgType:Int32, GeneratedEnum {
    case enumMsgTypeC2C = 0
    case enumMsgTypeGroup = 2
    case enumMsgTypeBroacast = 3
    case enumMsgCustom = 4
    public func toString() -> String {
        switch self {
        case .enumMsgTypeC2C: return "enum_msg_type_c2c"
        case .enumMsgTypeGroup: return "enum_msg_type_group"
        case .enumMsgTypeBroacast: return "enum_msg_type_broacast"
        case .enumMsgCustom: return "enum_msg_custom"
        }
    }
    public static func fromString(_ str:String) throws -> EnumMsgType {
        switch str {
        case "enum_msg_type_c2c":    return .enumMsgTypeC2C
        case "enum_msg_type_group":    return .enumMsgTypeGroup
        case "enum_msg_type_broacast":    return .enumMsgTypeBroacast
        case "enum_msg_custom":    return .enumMsgCustom
        default: throw ProtocolBuffersError.invalidProtocolBuffer("Conversion failed.")
        }
    }
    public var debugDescription:String { return getDescription() }
    ...
    private func getDescription() -> String { 
        switch self {
        case .enumMsgTypeC2C: return ".enumMsgTypeC2C"
        case .enumMsgTypeGroup: return ".enumMsgTypeGroup"
        case .enumMsgTypeBroacast: return ".enumMsgTypeBroacast"
        case .enumMsgCustom: return ".enumMsgCustom"
        }
    }
    public var hashValue:Int {
        return self.rawValue.hashValue
    }
    public static func ==(lhs:EnumMsgType, rhs:EnumMsgType) -> Bool {
        return lhs.hashValue == rhs.hashValue
    }
}
...
final public class GroupInfo : GeneratedMessage {
    public typealias BuilderType = GroupInfo.Builder
    ...
    public class func getBuilder() -> GroupInfo.Builder {
        return GroupInfo.classBuilder() as! GroupInfo.Builder
    }
    public func getBuilder() -> GroupInfo.Builder {
        return classBuilder() as! GroupInfo.Builder
    }
    override public class func classBuilder() -> ProtocolBuffersMessageBuilder {
    ...
    public func toBuilder() throws -> GroupInfo.Builder {
        return try GroupInfo.builderWithPrototype(prototype:self)
    }
    public class func builderWithPrototype(prototype:GroupInfo) throws -> GroupInfo.Builder {
        return try GroupInfo.Builder().mergeFrom(other:prototype)
    }
    override public func encode() throws -> Dictionary<String,Any> {
        try isInitialized()
    ...
    override class public func decode(jsonMap:Dictionary<String,Any>) throws -> GroupInfo {
        return try GroupInfo.Builder.decodeToBuilder(jsonMap:jsonMap).build()
    }
    override class public func fromJSON(data:Data) throws -> GroupInfo {
        return try GroupInfo.Builder.fromJSONToBuilder(data:data).build()
    }
    override public func getDescription(indent:String) throws -> String {
        var output = ""
        output += unknownFields.getDescription(indent: indent)
    ...
    final public class Builder : GeneratedMessageBuilder {
        fileprivate var builderResult:GroupInfo = GroupInfo()
        public func getMessage() -> GroupInfo {
            return builderResult
        }
        ...
        @discardableResult
        override public func clear() -> GroupInfo.Builder {
            builderResult = GroupInfo()
            return self
        }
        override public func clone() throws -> GroupInfo.Builder {
            return try GroupInfo.builderWithPrototype(prototype:builderResult)
        }
        override public func build() throws -> GroupInfo {
            try checkInitialized()
            return buildPartial()
        }
        public func buildPartial() -> GroupInfo {
            let returnMe:GroupInfo = builderResult
            return returnMe
        }
        @discardableResult
        public func mergeFrom(other:GroupInfo) throws -> GroupInfo.Builder {
            if other == GroupInfo() {
                return self
            }
            try merge(unknownField: other.unknownFields)
        ...
        @discardableResult
        override public func mergeFrom(codedInputStream: CodedInputStream) throws -> GroupInfo.Builder {
            return try mergeFrom(codedInputStream: codedInputStream, extensionRegistry:ExtensionRegistry())
        }
        @discardableResult
        override public func mergeFrom(codedInputStream: CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> GroupInfo.Builder {
            let unknownFieldsBuilder:UnknownFieldSet.Builder = try UnknownFieldSet.builderWithUnknownFields(copyFrom:self.unknownFields)
            while (true) {
                let protobufTag = try codedInputStream.readTag()
                switch protobufTag {
        ...
        class override public func decodeToBuilder(jsonMap:Dictionary<String,Any>) throws -> GroupInfo.Builder {
            let resultDecodedBuilder = GroupInfo.Builder()
            return resultDecodedBuilder
        }
        override class public func fromJSONToBuilder(data:Data) throws -> GroupInfo.Builder {
            let jsonData = try JSONSerialization.jsonObject(with:data, options: JSONSerialization.ReadingOptions(rawValue: 0))
            guard let jsDataCast = jsonData as? Dictionary<String,Any> else {
              throw ProtocolBuffersError.invalidProtocolBuffer("Invalid JSON data")
            }
            return try GroupInfo.Builder.decodeToBuilder(jsonMap:jsDataCast)
        }
    }

}

final public class C2CMsg : GeneratedMessage {
    public typealias BuilderType = C2CMsg.Builder

    public static func == (lhs: C2CMsg, rhs: C2CMsg) -> Bool {
        if lhs === rhs {
            return true
        }
        var fieldCheck:Bool = (lhs.hashValue == rhs.hashValue)
        ...
        fieldCheck = fieldCheck && (lhs.hasFromInfo == rhs.hasFromInfo) && (!lhs.hasFromInfo || lhs.fromInfo == rhs.fromInfo)
        fieldCheck = fieldCheck && (lhs.hasToInfo == rhs.hasToInfo) && (!lhs.hasToInfo || lhs.toInfo == rhs.toInfo)
    ...
    public fileprivate(set) var from:Int32! = nil
    public fileprivate(set) var hasFrom:Bool = false

    public fileprivate(set) var to:Int32! = nil
    public fileprivate(set) var hasTo:Bool = false

    public fileprivate(set) var fromInfo:UserInfo!
    public fileprivate(set) var hasFromInfo:Bool = false
    public fileprivate(set) var toInfo:UserInfo!
    public fileprivate(set) var hasToInfo:Bool = false
    ...
    override public func writeTo(codedOutputStream: CodedOutputStream) throws {
        if hasFrom {
            try codedOutputStream.writeInt32(fieldNumber: 1, value:from)
        }
        if hasTo {
            try codedOutputStream.writeInt32(fieldNumber: 2, value:to)
        }
        if hasFromInfo {
            try codedOutputStream.writeMessage(fieldNumber: 3, value:fromInfo)
        }
        if hasToInfo {
            try codedOutputStream.writeMessage(fieldNumber: 4, value:toInfo)
        }
        if hasType {
            try codedOutputStream.writeEnum(fieldNumber: 5, value:type.rawValue)
        }
        if hasContent {
            try codedOutputStream.writeData(fieldNumber: 6, value:content)
        }
        if hasExt {
    ...
    override public func serializedSize() -> Int32 {
        ...
        serialize_size = 0
        if hasFrom {
            serialize_size += from.computeInt32Size(fieldNumber: 1)
        }
        if hasTo {
            serialize_size += to.computeInt32Size(fieldNumber: 2)
        }
        if hasFromInfo {
            if let varSizefromInfo = fromInfo?.computeMessageSize(fieldNumber: 3) {
                serialize_size += varSizefromInfo
            }
        }
        if hasToInfo {
            if let varSizetoInfo = toInfo?.computeMessageSize(fieldNumber: 4) {
                serialize_size += varSizetoInfo
            }
        }
        if (hasType) {
        ...
        if hasContent {
            serialize_size += content.computeDataSize(fieldNumber: 6)
        }
        if hasExt {
    ...
    public class func getBuilder() -> C2CMsg.Builder {
        return C2CMsg.classBuilder() as! C2CMsg.Builder
    }
    public func getBuilder() -> C2CMsg.Builder {
        return classBuilder() as! C2CMsg.Builder
    }
    override public class func classBuilder() -> ProtocolBuffersMessageBuilder {
        return C2CMsg.Builder()
    }
    override public func classBuilder() -> ProtocolBuffersMessageBuilder {
        return C2CMsg.Builder()
    }
    public func toBuilder() throws -> C2CMsg.Builder {
        return try C2CMsg.builderWithPrototype(prototype:self)
    }
    public class func builderWithPrototype(prototype:C2CMsg) throws -> C2CMsg.Builder {
        return try C2CMsg.Builder().mergeFrom(other:prototype)
    }
    override public func encode() throws -> Dictionary<String,Any> {
        try isInitialized()
        var jsonMap:Dictionary<String,Any> = Dictionary<String,Any>()
        if hasFrom {
            jsonMap["from"] = Int(from)
        }
        if hasTo {
            jsonMap["to"] = Int(to)
        }
        if hasFromInfo {
            jsonMap["fromInfo"] = try fromInfo.encode()
        }
        if hasToInfo {
            jsonMap["toInfo"] = try toInfo.encode()
        }
        if hasType {
    ...
    override class public func decode(jsonMap:Dictionary<String,Any>) throws -> C2CMsg {
        return try C2CMsg.Builder.decodeToBuilder(jsonMap:jsonMap).build()
    }
    override class public func fromJSON(data:Data) throws -> C2CMsg {
        return try C2CMsg.Builder.fromJSONToBuilder(data:data).build()
    }
    override public func getDescription(indent:String) throws -> String {
        var output = ""
        if hasFrom {
        ...
        if hasFromInfo {
            output += "\(indent) fromInfo {\n"
            if let outDescFromInfo = fromInfo {
                output += try outDescFromInfo.getDescription(indent: "\(indent)  ")
            }
            output += "\(indent) }\n"
        }
        if hasToInfo {
            output += "\(indent) toInfo {\n"
            if let outDescToInfo = toInfo {
                output += try outDescToInfo.getDescription(indent: "\(indent)  ")
            }
            output += "\(indent) }\n"
        }
        if (hasType) {
    ...
    override public var hashValue:Int {
        get {
            ...
            if hasFromInfo {
                if let hashValuefromInfo = fromInfo?.hashValue {
                    hashCode = (hashCode &* 31) &+ hashValuefromInfo
                }
            }
            if hasToInfo {
                if let hashValuetoInfo = toInfo?.hashValue {
                    hashCode = (hashCode &* 31) &+ hashValuetoInfo
                }
            }
            if hasType {
    ...
    final public class Builder : GeneratedMessageBuilder {
        fileprivate var builderResult:C2CMsg = C2CMsg()
        public func getMessage() -> C2CMsg {
            return builderResult
        }
        ...
        @discardableResult
        public func setFrom(_ value:Int32) -> C2CMsg.Builder {
            self.from = value
            return self
        }
        @discardableResult
        public func clearFrom() -> C2CMsg.Builder{
        ...
        @discardableResult
        public func setTo(_ value:Int32) -> C2CMsg.Builder {
            self.to = value
            return self
        }
        @discardableResult
        public func clearTo() -> C2CMsg.Builder{
            builderResult.hasTo = false
            builderResult.to = nil
            return self
        }
        public var fromInfo:UserInfo! {
            get {
                if fromInfoBuilder_ != nil {
                    builderResult.fromInfo = fromInfoBuilder_.getMessage()
                }
                return builderResult.fromInfo
            }
            set (value) {
                builderResult.hasFromInfo = value != nil
                builderResult.fromInfo = value
            }
        }
        public var hasFromInfo:Bool {
            get {
                return builderResult.hasFromInfo
            }
        }
        fileprivate var fromInfoBuilder_:UserInfo.Builder! {
            didSet {
                builderResult.hasFromInfo = true
            }
        }
        public func getFromInfoBuilder() -> UserInfo.Builder {
            if fromInfoBuilder_ == nil {
                fromInfoBuilder_ = UserInfo.Builder()
                builderResult.fromInfo = fromInfoBuilder_.getMessage()
                if fromInfo != nil {
                    try! fromInfoBuilder_.mergeFrom(other: fromInfo)
                }
            }
            return fromInfoBuilder_
        }
        @discardableResult
        public func setFromInfo(_ value:UserInfo!) -> C2CMsg.Builder {
            self.fromInfo = value
            return self
        }
        @discardableResult
        public func mergeFromInfo(value:UserInfo) throws -> C2CMsg.Builder {
            if builderResult.hasFromInfo {
                builderResult.fromInfo = try UserInfo.builderWithPrototype(prototype:builderResult.fromInfo).mergeFrom(other: value).buildPartial()
            } else {
                builderResult.fromInfo = value
            }
            builderResult.hasFromInfo = true
        ...
        @discardableResult
        public func clearFromInfo() -> C2CMsg.Builder {
            fromInfoBuilder_ = nil
            builderResult.hasFromInfo = false
            builderResult.fromInfo = nil
            return self
        }
        public var toInfo:UserInfo! {
            get {
                if toInfoBuilder_ != nil {
                    builderResult.toInfo = toInfoBuilder_.getMessage()
                }
                return builderResult.toInfo
            }
            set (value) {
                builderResult.hasToInfo = value != nil
                builderResult.toInfo = value
            }
        }
        public var hasToInfo:Bool {
            get {
                return builderResult.hasToInfo
            }
        }
        fileprivate var toInfoBuilder_:UserInfo.Builder! {
            didSet {
                builderResult.hasToInfo = true
            }
        }
        public func getToInfoBuilder() -> UserInfo.Builder {
            if toInfoBuilder_ == nil {
                toInfoBuilder_ = UserInfo.Builder()
                builderResult.toInfo = toInfoBuilder_.getMessage()
                if toInfo != nil {
                    try! toInfoBuilder_.mergeFrom(other: toInfo)
                }
            }
            return toInfoBuilder_
        }
        @discardableResult
        public func setToInfo(_ value:UserInfo!) -> C2CMsg.Builder {
            self.toInfo = value
            return self
        }
        @discardableResult
        public func mergeToInfo(value:UserInfo) throws -> C2CMsg.Builder {
            if builderResult.hasToInfo {
                builderResult.toInfo = try UserInfo.builderWithPrototype(prototype:builderResult.toInfo).mergeFrom(other: value).buildPartial()
            } else {
                builderResult.toInfo = value
            }
            builderResult.hasToInfo = true
        ...
        @discardableResult
        public func clearToInfo() -> C2CMsg.Builder {
            toInfoBuilder_ = nil
            builderResult.hasToInfo = false
            builderResult.toInfo = nil
            return self
        }
        ...
        @discardableResult
            public func setType(_ value:EnumMsgContentType) -> C2CMsg.Builder {
              self.type = value
              return self
            }
        @discardableResult
            public func clearType() -> C2CMsg.Builder {
        ...
        @discardableResult
        public func setContent(_ value:Data) -> C2CMsg.Builder {
            self.content = value
            return self
        }
        @discardableResult
        public func clearContent() -> C2CMsg.Builder{
        ...
        @discardableResult
        public func setExt(_ value:ExtKeyInfo!) -> C2CMsg.Builder {
            self.ext = value
            return self
        }
        @discardableResult
        public func mergeExt(value:ExtKeyInfo) throws -> C2CMsg.Builder {
        ...
        @discardableResult
        public func clearExt() -> C2CMsg.Builder {
            extBuilder_ = nil
        ...
        @discardableResult
        override public func clear() -> C2CMsg.Builder {
            builderResult = C2CMsg()
            return self
        }
        override public func clone() throws -> C2CMsg.Builder {
            return try C2CMsg.builderWithPrototype(prototype:builderResult)
        }
        override public func build() throws -> C2CMsg {
            try checkInitialized()
            return buildPartial()
        }
        public func buildPartial() -> C2CMsg {
            let returnMe:C2CMsg = builderResult
            return returnMe
        }
        @discardableResult
        public func mergeFrom(other:C2CMsg) throws -> C2CMsg.Builder {
            if other == C2CMsg() {
                return self
            }
            if other.hasFrom {
            ...
            if (other.hasFromInfo) {
                try mergeFromInfo(value: other.fromInfo)
            }
            if (other.hasToInfo) {
                try mergeToInfo(value: other.toInfo)
            }
            if other.hasType {
                type = other.type
            }
        ...
        @discardableResult
        override public func mergeFrom(codedInputStream: CodedInputStream) throws -> C2CMsg.Builder {
            return try mergeFrom(codedInputStream: codedInputStream, extensionRegistry:ExtensionRegistry())
        }
        @discardableResult
        override public func mergeFrom(codedInputStream: CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> C2CMsg.Builder {
            let unknownFieldsBuilder:UnknownFieldSet.Builder = try UnknownFieldSet.builderWithUnknownFields(copyFrom:self.unknownFields)
            while (true) {
                let protobufTag = try codedInputStream.readTag()
                switch protobufTag {
                ...
                case 8:
                    from = try codedInputStream.readInt32()

                case 16:
                    to = try codedInputStream.readInt32()

                case 26:
                    let subBuilder:UserInfo.Builder = UserInfo.Builder()
                    if hasFromInfo {
                        try subBuilder.mergeFrom(other: fromInfo)
                    }
                    try codedInputStream.readMessage(builder: subBuilder, extensionRegistry:extensionRegistry)
                    fromInfo = subBuilder.buildPartial()

                case 34:
                    let subBuilder:UserInfo.Builder = UserInfo.Builder()
                    if hasToInfo {
                        try subBuilder.mergeFrom(other: toInfo)
                    }
                    try codedInputStream.readMessage(builder: subBuilder, extensionRegistry:extensionRegistry)
                    toInfo = subBuilder.buildPartial()
        ...
        class override public func decodeToBuilder(jsonMap:Dictionary<String,Any>) throws -> C2CMsg.Builder {
            let resultDecodedBuilder = C2CMsg.Builder()
            if let jsonValueFrom = jsonMap["from"] as? Int {
                resultDecodedBuilder.from = Int32(jsonValueFrom)
            } else if let jsonValueFrom = jsonMap["from"] as? String {
                resultDecodedBuilder.from = Int32(jsonValueFrom)!
            }
            if let jsonValueTo = jsonMap["to"] as? Int {
                resultDecodedBuilder.to = Int32(jsonValueTo)
            } else if let jsonValueTo = jsonMap["to"] as? String {
                resultDecodedBuilder.to = Int32(jsonValueTo)!
            }
            if let jsonValueFromInfo = jsonMap["fromInfo"] as? Dictionary<String,Any> {
                resultDecodedBuilder.fromInfo = try UserInfo.Builder.decodeToBuilder(jsonMap:jsonValueFromInfo).build()

            }
            if let jsonValueToInfo = jsonMap["toInfo"] as? Dictionary<String,Any> {
                resultDecodedBuilder.toInfo = try UserInfo.Builder.decodeToBuilder(jsonMap:jsonValueToInfo).build()
        ...
        override class public func fromJSONToBuilder(data:Data) throws -> C2CMsg.Builder {
            let jsonData = try JSONSerialization.jsonObject(with:data, options: JSONSerialization.ReadingOptions(rawValue: 0))
            guard let jsDataCast = jsonData as? Dictionary<String,Any> else {
              throw ProtocolBuffersError.invalidProtocolBuffer("Invalid JSON data")
            }
            return try C2CMsg.Builder.decodeToBuilder(jsonMap:jsDataCast)
        }
    }

}

final public class GroupMsg : GeneratedMessage {
    public typealias BuilderType = GroupMsg.Builder

    public static func == (lhs: GroupMsg, rhs: GroupMsg) -> Bool {
        if lhs === rhs {
            return true
        }
        var fieldCheck:Bool = (lhs.hashValue == rhs.hashValue)
        fieldCheck = fieldCheck && (lhs.hasGroupId == rhs.hasGroupId) && (!lhs.hasGroupId || lhs.groupId == rhs.groupId)
        fieldCheck = fieldCheck && (lhs.hasGroupInfo == rhs.hasGroupInfo) && (!lhs.hasGroupInfo || lhs.groupInfo == rhs.groupInfo)
        fieldCheck = fieldCheck && (lhs.hasType == rhs.hasType) && (!lhs.hasType || lhs.type == rhs.type)
        fieldCheck = fieldCheck && (lhs.hasContent == rhs.hasContent) && (!lhs.hasContent || lhs.content == rhs.content)
        fieldCheck = fieldCheck && (lhs.hasExt == rhs.hasExt) && (!lhs.hasExt || lhs.ext == rhs.ext)
        fieldCheck = (fieldCheck && (lhs.unknownFields == rhs.unknownFields))
    ...
    public fileprivate(set) var groupInfo:GroupInfo!
    public fileprivate(set) var hasGroupInfo:Bool = false
    public fileprivate(set) var type:EnumMsgContentType = EnumMsgContentType.enumMsgContentTypeText
    public fileprivate(set) var hasType:Bool = false
    public fileprivate(set) var content:Data! = nil
    public fileprivate(set) var hasContent:Bool = false
    ...
    override public func writeTo(codedOutputStream: CodedOutputStream) throws {
        if hasGroupId {
            try codedOutputStream.writeInt32(fieldNumber: 1, value:groupId)
        }
        if hasGroupInfo {
            try codedOutputStream.writeMessage(fieldNumber: 2, value:groupInfo)
        }
        if hasType {
            try codedOutputStream.writeEnum(fieldNumber: 3, value:type.rawValue)
        }
        if hasContent {
            try codedOutputStream.writeData(fieldNumber: 4, value:content)
        }
        if hasExt {
            try codedOutputStream.writeMessage(fieldNumber: 9, value:ext)
        }
    ...
    override public func serializedSize() -> Int32 {
        ...
        serialize_size = 0
        if hasGroupId {
            serialize_size += groupId.computeInt32Size(fieldNumber: 1)
        }
        if hasGroupInfo {
            if let varSizegroupInfo = groupInfo?.computeMessageSize(fieldNumber: 2) {
                serialize_size += varSizegroupInfo
            }
        }
        if (hasType) {
        ...
        if hasContent {
            serialize_size += content.computeDataSize(fieldNumber: 4)
        }
        if hasExt {
            if let varSizeext = ext?.computeMessageSize(fieldNumber: 9) {
                serialize_size += varSizeext
    ...
    public class func getBuilder() -> GroupMsg.Builder {
        return GroupMsg.classBuilder() as! GroupMsg.Builder
    }
    public func getBuilder() -> GroupMsg.Builder {
        return classBuilder() as! GroupMsg.Builder
    }
    override public class func classBuilder() -> ProtocolBuffersMessageBuilder {
    ...
    public func toBuilder() throws -> GroupMsg.Builder {
        return try GroupMsg.builderWithPrototype(prototype:self)
    }
    public class func builderWithPrototype(prototype:GroupMsg) throws -> GroupMsg.Builder {
        return try GroupMsg.Builder().mergeFrom(other:prototype)
    }
    override public func encode() throws -> Dictionary<String,Any> {
        try isInitialized()
        var jsonMap:Dictionary<String,Any> = Dictionary<String,Any>()
        ...
        if hasGroupInfo {
            jsonMap["groupInfo"] = try groupInfo.encode()
        }
        if hasType {
            jsonMap["type"] = type.toString()
        }
    ...
    override class public func decode(jsonMap:Dictionary<String,Any>) throws -> GroupMsg {
        return try GroupMsg.Builder.decodeToBuilder(jsonMap:jsonMap).build()
    }
    override class public func fromJSON(data:Data) throws -> GroupMsg {
        return try GroupMsg.Builder.fromJSONToBuilder(data:data).build()
    }
    override public func getDescription(indent:String) throws -> String {
        var output = ""
        if hasGroupId {
        ...
        if hasGroupInfo {
            output += "\(indent) groupInfo {\n"
            if let outDescGroupInfo = groupInfo {
                output += try outDescGroupInfo.getDescription(indent: "\(indent)  ")
            }
            output += "\(indent) }\n"
        }
        if (hasType) {
    ...
    override public var hashValue:Int {
        get {
            ...
            if hasGroupInfo {
                if let hashValuegroupInfo = groupInfo?.hashValue {
                    hashCode = (hashCode &* 31) &+ hashValuegroupInfo
                }
            }
            if hasType {
                 hashCode = (hashCode &* 31) &+ type.hashValue
    ...
    final public class Builder : GeneratedMessageBuilder {
        fileprivate var builderResult:GroupMsg = GroupMsg()
        public func getMessage() -> GroupMsg {
            return builderResult
        }
        ...
        @discardableResult
        public func setGroupId(_ value:Int32) -> GroupMsg.Builder {
            self.groupId = value
            return self
        }
        @discardableResult
        public func clearGroupId() -> GroupMsg.Builder{
        ...
        public var groupInfo:GroupInfo! {
            get {
                if groupInfoBuilder_ != nil {
                    builderResult.groupInfo = groupInfoBuilder_.getMessage()
                }
                return builderResult.groupInfo
            }
            set (value) {
                builderResult.hasGroupInfo = value != nil
                builderResult.groupInfo = value
            }
        }
        public var hasGroupInfo:Bool {
            get {
                return builderResult.hasGroupInfo
            }
        }
        fileprivate var groupInfoBuilder_:GroupInfo.Builder! {
            didSet {
                builderResult.hasGroupInfo = true
            }
        }
        public func getGroupInfoBuilder() -> GroupInfo.Builder {
            if groupInfoBuilder_ == nil {
                groupInfoBuilder_ = GroupInfo.Builder()
                builderResult.groupInfo = groupInfoBuilder_.getMessage()
                if groupInfo != nil {
                    try! groupInfoBuilder_.mergeFrom(other: groupInfo)
                }
            }
            return groupInfoBuilder_
        }
        @discardableResult
        public func setGroupInfo(_ value:GroupInfo!) -> GroupMsg.Builder {
            self.groupInfo = value
            return self
        }
        @discardableResult
        public func mergeGroupInfo(value:GroupInfo) throws -> GroupMsg.Builder {
            if builderResult.hasGroupInfo {
                builderResult.groupInfo = try GroupInfo.builderWithPrototype(prototype:builderResult.groupInfo).mergeFrom(other: value).buildPartial()
            } else {
                builderResult.groupInfo = value
            }
            builderResult.hasGroupInfo = true
        ...
        @discardableResult
        public func clearGroupInfo() -> GroupMsg.Builder {
            groupInfoBuilder_ = nil
            builderResult.hasGroupInfo = false
            builderResult.groupInfo = nil
            return self
        }
            public var type:EnumMsgContentType {
                get {
        ...
        @discardableResult
            public func setType(_ value:EnumMsgContentType) -> GroupMsg.Builder {
              self.type = value
              return self
            }
        @discardableResult
            public func clearType() -> GroupMsg.Builder {
               builderResult.hasType = false
               builderResult.type = .enumMsgContentTypeText
               return self
            }
        ...
        @discardableResult
        public func setContent(_ value:Data) -> GroupMsg.Builder {
            self.content = value
            return self
        }
        @discardableResult
        public func clearContent() -> GroupMsg.Builder{
            builderResult.hasContent = false
            builderResult.content = nil
            return self
        }
        ...
        @discardableResult
        public func setExt(_ value:ExtKeyInfo!) -> GroupMsg.Builder {
            self.ext = value
            return self
        }
        @discardableResult
        public func mergeExt(value:ExtKeyInfo) throws -> GroupMsg.Builder {
            if builderResult.hasExt {
                builderResult.ext = try ExtKeyInfo.builderWithPrototype(prototype:builderResult.ext).mergeFrom(other: value).buildPartial()
            } else {
                builderResult.ext = value
        ...
        @discardableResult
        public func clearExt() -> GroupMsg.Builder {
            extBuilder_ = nil
            builderResult.hasExt = false
            builderResult.ext = nil
            return self
        ...
        @discardableResult
        override public func clear() -> GroupMsg.Builder {
            builderResult = GroupMsg()
            return self
        }
        override public func clone() throws -> GroupMsg.Builder {
            return try GroupMsg.builderWithPrototype(prototype:builderResult)
        }
        override public func build() throws -> GroupMsg {
            try checkInitialized()
            return buildPartial()
        }
        public func buildPartial() -> GroupMsg {
            let returnMe:GroupMsg = builderResult
            return returnMe
        }
        @discardableResult
        public func mergeFrom(other:GroupMsg) throws -> GroupMsg.Builder {
            if other == GroupMsg() {
                return self
            }
            if other.hasGroupId {
            ...
            if (other.hasGroupInfo) {
                try mergeGroupInfo(value: other.groupInfo)
            }
            if other.hasType {
                type = other.type
            }
        ...
        @discardableResult
        override public func mergeFrom(codedInputStream: CodedInputStream) throws -> GroupMsg.Builder {
            return try mergeFrom(codedInputStream: codedInputStream, extensionRegistry:ExtensionRegistry())
        }
        @discardableResult
        override public func mergeFrom(codedInputStream: CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> GroupMsg.Builder {
            let unknownFieldsBuilder:UnknownFieldSet.Builder = try UnknownFieldSet.builderWithUnknownFields(copyFrom:self.unknownFields)
            while (true) {
                let protobufTag = try codedInputStream.readTag()
                switch protobufTag {
                ...
                case 18:
                    let subBuilder:GroupInfo.Builder = GroupInfo.Builder()
                    if hasGroupInfo {
                        try subBuilder.mergeFrom(other: groupInfo)
                    }
                    try codedInputStream.readMessage(builder: subBuilder, extensionRegistry:extensionRegistry)
        ...
        class override public func decodeToBuilder(jsonMap:Dictionary<String,Any>) throws -> GroupMsg.Builder {
            let resultDecodedBuilder = GroupMsg.Builder()
            ...
            if let jsonValueGroupInfo = jsonMap["groupInfo"] as? Dictionary<String,Any> {
                resultDecodedBuilder.groupInfo = try GroupInfo.Builder.decodeToBuilder(jsonMap:jsonValueGroupInfo).build()
        ...
        override class public func fromJSONToBuilder(data:Data) throws -> GroupMsg.Builder {
            let jsonData = try JSONSerialization.jsonObject(with:data, options: JSONSerialization.ReadingOptions(rawValue: 0))
            guard let jsDataCast = jsonData as? Dictionary<String,Any> else {
              throw ProtocolBuffersError.invalidProtocolBuffer("Invalid JSON data")
            }
            return try GroupMsg.Builder.decodeToBuilder(jsonMap:jsDataCast)
        }
    }
...
final public class BaseMsg : GeneratedMessage {
    ...
    public fileprivate(set) var type:EnumMsgType = EnumMsgType.enumMsgTypeC2C
    public fileprivate(set) var hasType:Bool = false
    ...
    final public class Builder : GeneratedMessageBuilder {
        ...
        @discardableResult
            public func setType(_ value:EnumMsgType) -> BaseMsg.Builder {
              self.type = value
              return self
            }
        @discardableResult
            public func clearType() -> BaseMsg.Builder {
               builderResult.hasType = false
               builderResult.type = .enumMsgTypeC2C
               return self
            }
        ...
        @discardableResult
        public func setBody(_ value:Data) -> BaseMsg.Builder {
            self.body = value
            return self
        }
        @discardableResult
        public func clearBody() -> BaseMsg.Builder{
        ...
        override public func mergeFrom(codedInputStream: CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> BaseMsg.Builder {
            ...
            while (true) {
                ...
                case 8:
                    let valueInttype = try codedInputStream.readEnum()
                    if let enumstype = EnumMsgType(rawValue:valueInttype){
                        type = enumstype
                    } else {
        ...
        class override public func decodeToBuilder(jsonMap:Dictionary<String,Any>) throws -> BaseMsg.Builder {
            ...
            if let jsonValueType = jsonMap["type"] as? String {
                resultDecodedBuilder.type = try EnumMsgType.fromString(jsonValueType)
            }
...
extension GroupInfo: GeneratedMessageProtocol {
    public class func parseArrayDelimitedFrom(inputStream: InputStream) throws -> Array<GroupInfo> {
        var mergedArray = Array<GroupInfo>()
        while let value = try parseDelimitedFrom(inputStream: inputStream) {
          mergedArray.append(value)
        }
        return mergedArray
    }
    public class func parseDelimitedFrom(inputStream: InputStream) throws -> GroupInfo? {
        return try GroupInfo.Builder().mergeDelimitedFrom(inputStream: inputStream)?.build()
    }
    public class func parseFrom(data: Data) throws -> GroupInfo {
        return try GroupInfo.Builder().mergeFrom(data: data, extensionRegistry:MessageRoot.default.extensionRegistry).build()
    }
    public class func parseFrom(data: Data, extensionRegistry:ExtensionRegistry) throws -> GroupInfo {
        return try GroupInfo.Builder().mergeFrom(data: data, extensionRegistry:extensionRegistry).build()
    }
    public class func parseFrom(inputStream: InputStream) throws -> GroupInfo {
        return try GroupInfo.Builder().mergeFrom(inputStream: inputStream).build()
    }
    public class func parseFrom(inputStream: InputStream, extensionRegistry:ExtensionRegistry) throws -> GroupInfo {
        return try GroupInfo.Builder().mergeFrom(inputStream: inputStream, extensionRegistry:extensionRegistry).build()
    }
    public class func parseFrom(codedInputStream: CodedInputStream) throws -> GroupInfo {
        return try GroupInfo.Builder().mergeFrom(codedInputStream: codedInputStream).build()
    }
    public class func parseFrom(codedInputStream: CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> GroupInfo {
        return try GroupInfo.Builder().mergeFrom(codedInputStream: codedInputStream, extensionRegistry:extensionRegistry).build()
    }
    public subscript(key: String) -> Any? {
        return nil
    }
}
extension GroupInfo.Builder: GeneratedMessageBuilderProtocol {
    public typealias GeneratedMessageType = GroupInfo
    public subscript(key: String) -> Any? {
        get { return nil }
        set { }
    }
}
extension C2CMsg: GeneratedMessageProtocol {
    public class func parseArrayDelimitedFrom(inputStream: InputStream) throws -> Array<C2CMsg> {
        var mergedArray = Array<C2CMsg>()
        while let value = try parseDelimitedFrom(inputStream: inputStream) {
          mergedArray.append(value)
        }
        return mergedArray
    }
    public class func parseDelimitedFrom(inputStream: InputStream) throws -> C2CMsg? {
        return try C2CMsg.Builder().mergeDelimitedFrom(inputStream: inputStream)?.build()
    }
    public class func parseFrom(data: Data) throws -> C2CMsg {
        return try C2CMsg.Builder().mergeFrom(data: data, extensionRegistry:MessageRoot.default.extensionRegistry).build()
    }
    public class func parseFrom(data: Data, extensionRegistry:ExtensionRegistry) throws -> C2CMsg {
        return try C2CMsg.Builder().mergeFrom(data: data, extensionRegistry:extensionRegistry).build()
    }
    public class func parseFrom(inputStream: InputStream) throws -> C2CMsg {
        return try C2CMsg.Builder().mergeFrom(inputStream: inputStream).build()
    }
    public class func parseFrom(inputStream: InputStream, extensionRegistry:ExtensionRegistry) throws -> C2CMsg {
        return try C2CMsg.Builder().mergeFrom(inputStream: inputStream, extensionRegistry:extensionRegistry).build()
    }
    public class func parseFrom(codedInputStream: CodedInputStream) throws -> C2CMsg {
        return try C2CMsg.Builder().mergeFrom(codedInputStream: codedInputStream).build()
    }
    public class func parseFrom(codedInputStream: CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> C2CMsg {
        return try C2CMsg.Builder().mergeFrom(codedInputStream: codedInputStream, extensionRegistry:extensionRegistry).build()
    }
    public subscript(key: String) -> Any? {
        switch key {
        case "from": return self.from
        case "to": return self.to
        case "fromInfo": return self.fromInfo
        case "toInfo": return self.toInfo
...
extension C2CMsg.Builder: GeneratedMessageBuilderProtocol {
    public typealias GeneratedMessageType = C2CMsg
    public subscript(key: String) -> Any? {
        get { 
            switch key {
            case "from": return self.from
        ...
        set (newSubscriptValue) { 
            ...
            case "fromInfo":
                ...
                self.fromInfo = newSubscriptValue
            case "toInfo":
                guard let newSubscriptValue = newSubscriptValue as? UserInfo else {
                    return
                }
                self.toInfo = newSubscriptValue
            case "type":
...
extension GroupMsg: GeneratedMessageProtocol {
    public class func parseArrayDelimitedFrom(inputStream: InputStream) throws -> Array<GroupMsg> {
        var mergedArray = Array<GroupMsg>()
        while let value = try parseDelimitedFrom(inputStream: inputStream) {
          mergedArray.append(value)
        }
        return mergedArray
    }
    public class func parseDelimitedFrom(inputStream: InputStream) throws -> GroupMsg? {
        return try GroupMsg.Builder().mergeDelimitedFrom(inputStream: inputStream)?.build()
    }
    public class func parseFrom(data: Data) throws -> GroupMsg {
        return try GroupMsg.Builder().mergeFrom(data: data, extensionRegistry:MessageRoot.default.extensionRegistry).build()
    }
    public class func parseFrom(data: Data, extensionRegistry:ExtensionRegistry) throws -> GroupMsg {
        return try GroupMsg.Builder().mergeFrom(data: data, extensionRegistry:extensionRegistry).build()
    }
    public class func parseFrom(inputStream: InputStream) throws -> GroupMsg {
        return try GroupMsg.Builder().mergeFrom(inputStream: inputStream).build()
    }
    public class func parseFrom(inputStream: InputStream, extensionRegistry:ExtensionRegistry) throws -> GroupMsg {
        return try GroupMsg.Builder().mergeFrom(inputStream: inputStream, extensionRegistry:extensionRegistry).build()
    }
    public class func parseFrom(codedInputStream: CodedInputStream) throws -> GroupMsg {
        return try GroupMsg.Builder().mergeFrom(codedInputStream: codedInputStream).build()
    }
    public class func parseFrom(codedInputStream: CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> GroupMsg {
        return try GroupMsg.Builder().mergeFrom(codedInputStream: codedInputStream, extensionRegistry:extensionRegistry).build()
    }
    public subscript(key: String) -> Any? {
        switch key {
        case "groupId": return self.groupId
        case "groupInfo": return self.groupInfo
        case "type": return self.type
        case "content": return self.content
        case "ext": return self.ext
        default: return nil
...
extension GroupMsg.Builder: GeneratedMessageBuilderProtocol {
    public typealias GeneratedMessageType = GroupMsg
    public subscript(key: String) -> Any? {
        get { 
            switch key {
            case "groupId": return self.groupId
        ...
        set (newSubscriptValue) { 
            ...
            case "groupInfo":
                guard let newSubscriptValue = newSubscriptValue as? GroupInfo else {
                    return
                }
                self.groupInfo = newSubscriptValue
            case "type":
                guard let newSubscriptValue = newSubscriptValue as? EnumMsgContentType else {
                    return
                }
...
extension BaseMsg.Builder: GeneratedMessageBuilderProtocol {
    ...
    public subscript(key: String) -> Any? {
        ...
        set (newSubscriptValue) { 
            switch key {
            case "type":
                guard let newSubscriptValue = newSubscriptValue as? EnumMsgType else {
                    return
                }
                self.type = newSubscriptValue
            case "body":
